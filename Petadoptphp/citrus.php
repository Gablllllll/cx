    ...
    <main>
        <section class="collection-section" id="features">
            ...
            <div class="button-grid">
                <a href="order.php?name=King Harus%20&image=img/dog1.jpg" class="collection-item">
                    <p class="item-name">King Harus</p>
                    <img src="img/dog1.jpg" alt="Velvet Paw" class="collection-image">
                    
                </a>
                <a href="order.php?name=Doghiskhan%20&image=img/dog2.jpg" class="collection-item">
                    <p class="item-name">Doghiskhan</p>
                    <img src="img/dog2.jpg" alt="Silver Whiskers" class="collection-image">
                    
                </a>
                <a href="order.php?name=Flower%20&image=img/dog3.jpg" class="collection-item">
                    <p class="item-name">Flower</p>
                    <img src="img/dog3.jpg" alt="Playful Swipe" class="collection-image">
                    
                </a>
                <a href="order.php?name=Peter Gladiator%20Cat&image=img/dog4.jpg" class="collection-item">
