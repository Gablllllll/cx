    ...
    <main>
        <section class="collection-section" id="home">
            ...
            <div class="button-grid">
                <a href="order.php?name=Mohammad%20Kashmir&image=img/cat1.jpg" class="collection-item">
                    <p class="item-name">Mohammad Kashmir</p>
                    <img src="img/cat1.jpg" alt="Velvet Paw" class="collection-image">
                </a>
                <a href="order.php?name=Catosigma%20&price=$24.99&image=img/cat2.jpg" class="collection-item">
                    <p class="item-name">Catosigma</p>
                    <img src="img/cat2.jpg" alt="Silver Whiskers" class="collection-image">
                </a>
                <a href="order.php?name=Robert%20&price=$19.99&image=img/cat3.jpg" class="collection-item">
                    <p class="item-name">Robert</p>
                    <img src="img/cat3.jpg" alt="Playful Swipe" class="collection-image">
                </a>
                <a href="order.php?name=Rigby%20Cat&image=img/cat4.jpg" class="collection-item">
